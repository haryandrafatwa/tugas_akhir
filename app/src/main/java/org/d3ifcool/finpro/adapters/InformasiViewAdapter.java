...
import org.d3ifcool.finpro.activities.detail.InformasiDetailActivity;
 ...
 */
public class InformasiViewAdapter extends RecyclerView.Adapter<InformasiViewAdapter.ViewHolder> {

    private ArrayList<Informasi> data;
    private Context context;

    public InformasiViewAdapter(Context context) {
    ...
    @Override
    public InformasiViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(InformasiViewAdapter.ViewHolder holder, final int position) {
