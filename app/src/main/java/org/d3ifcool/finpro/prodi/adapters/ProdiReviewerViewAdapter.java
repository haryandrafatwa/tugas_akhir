 ...
 */
public class ProdiReviewerViewAdapter extends RecyclerView.Adapter<ProdiReviewerViewAdapter.ViewHolder> {

    private Context context;
    private ArrayList<ProyekAkhir> data;
    private int layoutType;

    public ProdiReviewerViewAdapter(Context context) {
    ...
    @Override
    public void onBindViewHolder(final ProdiReviewerViewAdapter.ViewHolder holder, final int position) {
...
//                context.startActivity(intentData);
    ...
    @NonNull
    @Override
    public ProdiReviewerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new ProdiReviewerViewAdapter.ViewHolder(v);
    }
