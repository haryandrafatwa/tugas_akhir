 ...
 * -----------------------------------------
 */
public class Koordinator implements Parcelable {
    ...
    public Koordinator(String koor_nip, String koor_nama, String koor_kode, String koor_kontak, String koor_foto, String koor_email, String username) {
    ...
    protected Koordinator(Parcel in) {
    ...
    public static final Creator<Koordinator> CREATOR = new Creator<Koordinator>() {
        @Override
        public Koordinator createFromParcel(Parcel source) {
            return new Koordinator(source);
        }

        @Override
        public Koordinator[] newArray(int size) {
            return new Koordinator[size];
        }
    };
}
